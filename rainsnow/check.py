    ...
    try:
        ...
        if 't2m' in dataset_temp.variables:
            ...
            if 'refc' in dataset_refc.variables:
                ...
                # Set up the Basemap
                fig, ax = plt.subplots(figsize=(12, 8))  # Larger figure size for both colorbars
                ...
                # Add colorbars for both snow and rain
                ...
                # Add a legend for rain and snow scales
                ...
                plt.title(f'{snow_or_rain} - Reflectivity at 2m Above Ground - {output_filename} ({forecast_step})', fontsize=14)
                plt.tight_layout()

                # Save the plot as a PNG file
                plt.savefig(output_filename, dpi=150)  # Higher dpi for better quality
                plt.close()
